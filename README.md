...
<!-- 🎨 CUSTOMIZE: Update project links, descriptions, and stars -->

| Project | Description | Tools |
|---------|-------------|-------|
| [🤖 AI Freelancer Assistant](https://github.com/zicots7) | 3 Spring Boot microservices using Google Gemini AI · Smart Proposal Generator · Invoice Dispute Analyzer · Swagger/OpenAPI · Docker + K8s | `Java` `Spring Boot` `Gemini AI` `Docker` `K8s` |
| [💼 Freelancer Project & Payment Tracker](https://github.com/zicots7) | Multi-role platform · PDF invoice microservice · Dual-DB (PostgreSQL + MongoDB) · GitHub Actions CI/CD · 40% smaller Docker images | `Java` `Spring Boot` `PostgreSQL` `MongoDB` `GitHub Actions` |
| [🎓 College Event & Resource Management](https://github.com/zicots7) | Three-tier role system (Students/Faculty/Admin) · Tag-based MongoDB resource search · Kubernetes orchestration | `Java` `Spring Boot` `MongoDB` `Kubernetes` `Bootstrap` |
...
<!-- Wakatime Stats -->
<img src="https://github-readme-stats.vercel.app/api/wakatime?username=zicots7&theme=github_dark&hide_border=true&bg_color=0d1117" alt="Wakatime"/>
<!-- Activity Graph -->
<img src="https://github-readme-activity-graph.vercel.app/graph?username=zicots7&theme=github-compact&hide_border=true&bg_color=0d1117&color=6db33f&line=6db33f&point=ffffff" alt="Activity Graph"/>
</div>
---
...
|-------|--------------|---------|
| ☸️ | Docker, Kubernetes, GitOps with ArgoCD & Continuous Delivery | Udemy |
| 🔀 | Git, GitHub & GitLab — Version Control | Udemy |
| 🐍 | Django Developer Certification | Udemy |
...
*"Build it. Containerize it. Ship it."*
